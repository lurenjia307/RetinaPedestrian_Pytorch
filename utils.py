...
class RegressionTransform(nn.Module):
    def __init__(self,mean=None,std_box=None,std_ldm=None):
        ...
        if std_ldm is None:
            ...
            # self.std_ldm = (torch.ones(1,10) * 0.1)   #disable by yzk for pedestain
            self.std_ldm = (torch.ones(1, 4) * 0.1)   #add by yzk for pedestain
    ...
    def forward(self,anchors,bbox_deltas,ldm_deltas,img):
        ...
        # pt2_x = ctr_x + ldm_deltas[:,:,4] * widths  #disable by yzk for pedestain dect

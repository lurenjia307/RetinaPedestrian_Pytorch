...
def get_args():
    ...
    parser.add_argument('--image_path', type=str, default='0_Parade_marchingband_3.jpg', help='Path for image to detect')
    parser.add_argument('--model_path', type=str, default='G:\\codes\\download\\model_Best_epoch_48.pt', help='Path for model')
